...
/******************************************************************************
    ...
    返 回 值：无
*******************************************************************************/
static int rtu_tiaoya_ctl(char rtu_addr)
{
    int i;
    char buff[64] = {0};
    char len;
...
/******************************************************************************
    ...
    返 回 值：无
*******************************************************************************/
int rtu_jiutou_ctl_set(char rtu_addr, unsigned short jt_ctl_cmd,
                        unsigned short reg_jt_ctl)
{
	...
	rtu.jt_ctl_cmd[rtu_addr - 1][index++] = jt_ctl_cmd;
...
/******************************************************************************
    ...
    返 回 值：无
*******************************************************************************/
int rtu_jiutou_arg_set(char rtu_addr, unsigned short jt_arg_cmd,
...
/******************************************************************************
    ...
    返 回 值：无
*******************************************************************************/
int rtu_jiutou_dat_get(char rtu_addr, unsigned short jt_dat_index,
...
int rtu_tiaoya_ctl_set(char rtu_addr, unsigned short ty_ctl_cmd,
                       ...
                       unsigned short *reg_ty_dat)
{
    ...
    {
        *reg_ty_dat = rtu.reg_ty_dat[rtu_addr - 1][ty_dat_index];
        return 0;
    }
