...
silent only
cd E:\fenjiu_pro\fenjiuji\App\Src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +99 E:\fenjiu_pro\fenjiuji\App\Src\main.c
badd +274 E:\fenjiu_pro\fenjiuji\App\Src\task_wifi.c
badd +809 E:\fenjiu_pro\fenjiuji\App\Src\divid_cap.c
badd +62 E:\fenjiu_pro\fenjiuji\App\Src\store_param.c
badd +18 E:\fenjiu_pro\fenjiuji\App\Src\task_rtu.c
badd +26 E:\fenjiu_pro\fenjiuji\App\Inc\task_rtu.h
badd +0 E:\fenjiu_pro\fenjiuji\App\Inc\task_lcd.h
argglobal
silent! argdel *
edit E:\fenjiu_pro\fenjiuji\App\Src\divid_cap.c
...
exe 'vert 2resize ' . ((&columns * 109 + 91) / 183)
exe 'vert 3resize ' . ((&columns * 42 + 91) / 183)
argglobal
enew
file E:\fenjiu_pro\fenjiuji\App\Src\__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 424 - ((5 * winheight(0) + 22) / 45)
...
wincmd w
argglobal
edit E:\fenjiu_pro\fenjiuji\App\Inc\task_lcd.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
