...
extern int ESP8226_server_listening(int *link_id, unsigned short time);
...
extern int esp8266_mux_receive(int *link_id, char *rxbuf, int size);
extern int esp8266_mux_send(int link_id, char *txbuf, int len);
